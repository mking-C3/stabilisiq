    ...
    <footer className="bg-ink-900 text-ink-400 border-t border-paper/5">
      <div className="mx-auto max-w-6xl px-5 py-12">
        <div className="flex flex-col md:flex-row gap-6 md:items-center md:justify-between">
          ...
          <div className="flex flex-wrap gap-x-7 gap-y-2 font-mono text-[11px] uppercase tracking-[0.18em]">
        ...
        <div className="mt-10 pt-6 border-t border-paper/5 font-mono text-[11px] uppercase tracking-[0.15em] text-ink-500 flex flex-col sm:flex-row gap-3 sm:items-center sm:justify-between">
          <span>© {new Date().getFullYear()} StabilisIQ · All rights reserved</span>
          <span className="text-ink-600 tabular-nums">stabilisiq.com</span>
        </div>
      </div>
    </footer>
  );
