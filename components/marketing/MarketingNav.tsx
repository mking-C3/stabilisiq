  ...
  return (
    <header className="sticky top-0 z-40 bg-ink-900/80 backdrop-blur-xl border-b border-paper/5">
      <div className="mx-auto max-w-6xl px-5 h-16 flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center gap-8 font-mono text-[11px] uppercase tracking-[0.18em] text-ink-300">
        ...
        <a
          ...
          className="group inline-flex items-center gap-2 rounded-full bg-paper text-ink-900 pl-4 pr-2 py-1.5 text-[13px] font-medium hover:bg-white transition active:scale-[0.98]"
        >
          Book a fit check
