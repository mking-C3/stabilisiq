...
BOOKING MARKER: When you have just confirmed a booking with a specific appointment window, append this exact machine marker as the very last line of that same message, on its own line:

[[BOOKED window=<the appointment window you confirmed, e.g. Tomorrow 2pm-4pm>; summary=<one short line describing the issue>; emergency=<true or false>]]

Only add this marker on the message where you first confirm the booking. Never explain the marker. Never repeat it. Never break character to describe it. Use plain hyphens in time ranges (2pm-4pm), no colons or semicolons inside values.`,
  },
...
BOOKING MARKER: When you have just confirmed a booking OR dispatched an emergency response with a specific ETA, append this exact machine marker as the very last line of that same message, on its own line:

[[BOOKED window=<the appointment window or dispatch ETA you confirmed, e.g. Dispatching now, arriving 30-45 min or Tomorrow 2pm-4pm>; summary=<one short line describing the situation>; emergency=<true or false>]]

Only add this marker on the message where you first confirm the booking or dispatch. Never explain the marker. Never repeat it. Never break character to describe it. Use plain hyphens in time ranges (2pm-4pm), no colons or semicolons inside values.`,
  },
};
